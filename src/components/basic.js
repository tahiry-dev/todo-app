            ...
            <div class="projects col-12 col-md-4">
                <div id="project-card" class="card">
                    ...
                    <div class="input-group mb-3 card-body">
                        <input type="text" class="form-control" placeholder="Project Category name"
                            aria-label="Project Category" aria-describedby="button-addon2" required="true">
                        <button id= "project-name" class="btn btn-outline-info" type="button" id="button-addon2">Add</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Describe your task</h5>
