...
/***/ "./src/components/displayEffects.js":
/*!******************************************!*\
  !*** ./src/components/displayEffects.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dimBackground": () => (/* binding */ dimBackground),
/* harmony export */   "lightBackground": () => (/* binding */ lightBackground)
/* harmony export */ });
...
/* harmony export */   "renderListContent": () => (/* binding */ renderListContent),
/* harmony export */   "renderActiveList": () => (/* binding */ renderActiveList)
/* harmony export */ });
/* harmony import */ var _toDoController__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toDoController */ "./src/components/toDoController.js");
...
const renderLists = () => {
  ...
  if (_toDoController__WEBPACK_IMPORTED_MODULE_0__.toDoArray.length === 0) {
  ...
  _toDoController__WEBPACK_IMPORTED_MODULE_0__.toDoArray.forEach((elem) => {
  ...
  listbtn.forEach(btn => {
    for (let i = 0; i < _toDoController__WEBPACK_IMPORTED_MODULE_0__.toDoArray.length; i += 1) {
      if (btn.getAttribute('value') === _toDoController__WEBPACK_IMPORTED_MODULE_0__.toDoArray[i].id) {
        if (_toDoController__WEBPACK_IMPORTED_MODULE_0__.toDoArray[i].active === true) {
...
const renderListContent = () => {
  ...
  _toDoController__WEBPACK_IMPORTED_MODULE_0__.toDoArray.forEach(list => {
...
const renderActiveList = (val, targetList, allLists) => {
...
/***/ "./src/components/renderPopUpBox.js":
/*!******************************************!*\
  !*** ./src/components/renderPopUpBox.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "displayAddBox": () => (/* binding */ displayAddBox),
/* harmony export */   "displayNewListBox": () => (/* binding */ displayNewListBox),
/* harmony export */   "displayEditListBox": () => (/* binding */ displayEditListBox),
/* harmony export */   "confirmBoxLists": () => (/* binding */ confirmBoxLists),
/* harmony export */   "removeBox": () => (/* binding */ removeBox)
/* harmony export */ });
/* harmony import */ var _displayEffects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./displayEffects */ "./src/components/displayEffects.js");
/* harmony import */ var _toDoController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./toDoController */ "./src/components/toDoController.js");
/* eslint-disable import/no-cycle */
...
const displayAddBox = () => {
  ...
  _toDoController__WEBPACK_IMPORTED_MODULE_1__.toDoArray.forEach(list => {
    if (list.active === true) {
...
/***/ "./src/components/toDoController.js":
/*!******************************************!*\
  !*** ./src/components/toDoController.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _displayEffects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./displayEffects */ "./src/components/displayEffects.js");
/* harmony import */ var _renderDom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renderDom */ "./src/components/renderDom.js");
/* harmony import */ var _renderPopUpBox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./renderPopUpBox */ "./src/components/renderPopUpBox.js");
/* eslint-disable import/no-cycle */
...
const addNewToDo = () => {
  ...
  if (getInput('box-date') !== '') {
    date = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(new Date(getInput('box-date')), 'dd/MM/yyyy');
  }
  ...
  for (let i = 0; i < toDoArray.length; i += 1) {
    if (toDoArray[i].active === true) {
      ...
      (0,_renderDom__WEBPACK_IMPORTED_MODULE_1__.renderListContent)();
      (0,_displayEffects__WEBPACK_IMPORTED_MODULE_0__.lightBackground)();
...
const removeList = (val) => {
  toDoArray.forEach((list, index) => {
    if (list.id === val.value) {
      ...
      (0,_renderDom__WEBPACK_IMPORTED_MODULE_1__.renderLists)();
      (0,_renderDom__WEBPACK_IMPORTED_MODULE_1__.renderListContent)();
      (0,_renderPopUpBox__WEBPACK_IMPORTED_MODULE_2__.removeBox)();
    }
  });
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_renderDom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/renderDom */ "./src/components/renderDom.js");
/* harmony import */ var _components_renderPopUpBox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/renderPopUpBox */ "./src/components/renderPopUpBox.js");
/* harmony import */ var _components_toDoController__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/toDoController */ "./src/components/toDoController.js");
...
document.body.addEventListener('click', e => {
  ...
  switch (target) {
    case 'add-btn':
      document.body.append((0,_components_renderPopUpBox__WEBPACK_IMPORTED_MODULE_1__.displayAddBox)());
      break;
    case 'trash-svg-todos':
      (0,_components_toDoController__WEBPACK_IMPORTED_MODULE_2__.removeToDo)(e.target.parentElement.parentElement);
      break;
    case 'remove-todo-btn':
      (0,_components_toDoController__WEBPACK_IMPORTED_MODULE_2__.removeToDo)(e.target);
      break;
    case 'box-cancel-btn':
      (0,_components_renderPopUpBox__WEBPACK_IMPORTED_MODULE_1__.removeBox)();
      break;
    case 'add-todo-btn':
      (0,_components_toDoController__WEBPACK_IMPORTED_MODULE_2__.addNewToDo)();
      (0,_components_renderDom__WEBPACK_IMPORTED_MODULE_0__.renderListContent)();
      break;
    case 'lists-add-btn':
      document.body.appendChild((0,_components_renderPopUpBox__WEBPACK_IMPORTED_MODULE_1__.displayNewListBox)());
      break;
    case 'trash-svg-lists':
      document.body.appendChild((0,_components_renderPopUpBox__WEBPACK_IMPORTED_MODULE_1__.confirmBoxLists)(e.target.parentElement.parentElement));
      break;
    case 'remove-list-btn':
      (0,_components_toDoController__WEBPACK_IMPORTED_MODULE_2__.removeList)(e.target);
      (0,_components_renderDom__WEBPACK_IMPORTED_MODULE_0__.renderListContent)();
      break;
    case 'add-list-btn':
      (0,_components_toDoController__WEBPACK_IMPORTED_MODULE_2__.addNewList)();
      (0,_components_renderDom__WEBPACK_IMPORTED_MODULE_0__.renderLists)();
      (0,_components_renderDom__WEBPACK_IMPORTED_MODULE_0__.renderListContent)();
      break;
    case 'bg-focus':
      (0,_components_renderPopUpBox__WEBPACK_IMPORTED_MODULE_1__.removeBox)();
      break;
    case 'todo-item':
      (0,_components_toDoController__WEBPACK_IMPORTED_MODULE_2__.toggleToDoStatus)(e.target.getAttribute('value'),
        e.target.textContent);
      (0,_components_renderDom__WEBPACK_IMPORTED_MODULE_0__.renderListContent)();
      break;
    case 'lists-tab-link':
      (0,_components_toDoController__WEBPACK_IMPORTED_MODULE_2__.setActiveList)(e.target.value);
      (0,_components_renderDom__WEBPACK_IMPORTED_MODULE_0__.renderActiveList)(e.target.value,
        e.target,
        e.target.parentElement);
      (0,_components_renderDom__WEBPACK_IMPORTED_MODULE_0__.renderListContent)();
      break;
    case 'edit-svg-lists':
      document.body.appendChild((0,_components_renderPopUpBox__WEBPACK_IMPORTED_MODULE_1__.displayEditListBox)(e.target.parentElement.parentElement));

      break;
    case 'edit-list-btn':
      (0,_components_toDoController__WEBPACK_IMPORTED_MODULE_2__.editList)(e.target,
